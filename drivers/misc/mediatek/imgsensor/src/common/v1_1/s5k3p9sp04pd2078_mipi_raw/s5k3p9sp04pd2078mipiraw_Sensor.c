 ...
 * Filename:
 * ---------
 *	 s5k3p9sp04pd2078mipiraw_Sensor.c
 *
 * Project:
 * --------
 *	 ALPS
...
#include "s5k3p9sp04pd2078mipiraw_Sensor.h"
...
static struct imgsensor_info_struct imgsensor_info = {
	.sensor_id = S5K3P9SP04PD2078_SENSOR_ID,
...
extern otp_error_code_t S5K3P9SP04PD2078_OTP_ERROR_CODE;
MUINT32  sn_inf_sub_s5k3p9sp04pd2078[13];  /*0 flag   1-12 data*/
MUINT32 crosstalk_data[2049];  /*0 flag   1-836 data*/
MUINT32  material_inf_sub_s5k3p9sp04pd2078[4];  
			...
			*sensor_id = ((read_cmos_sensor_16_8(0x0000) << 8) | read_cmos_sensor_16_8(0x0001));
			...
			if (*sensor_id == imgsensor_info.sensor_id) {
			 ...
			 /*vivo hope add for AT cammand start*/
				...
				PK_DBG("cfx_add:end read eeprom ---vivo_otp_read_when_power_on = %d,S5K3P9SP04PD2078_OTP_ERROR_CODE =%d\n", vivo_otp_read_when_power_on, S5K3P9SP04PD2078_OTP_ERROR_CODE);
				/*vivo hope  add end*/
				return ERROR_NONE;
				  ...
				  UINT8 *feature_para, UINT32 *feature_para_len)
{
	...
	case SENSOR_FEATURE_GET_CUSTOM_INFO:
	    printk("SENSOR_FEATURE_GET_CUSTOM_INFO information type:%lld  S5K3P9SP04PD2078_OTP_ERROR_CODE:%d \n", *feature_data,S5K3P9SP04PD2078_OTP_ERROR_CODE);
		switch (*feature_data) {
			...
			if (*feature_para_len >= sizeof(MUINT32)*13 + 2) {
			    *(MUINT32 *)(uintptr_t)(*(feature_data+1)) = S5K3P9SP04PD2078_OTP_ERROR_CODE;//otp_state
				memcpy( feature_data+2, sn_inf_sub_s5k3p9sp04pd2078, sizeof(MUINT32)*13); 
				memcpy( feature_data+10, material_inf_sub_s5k3p9sp04pd2078, sizeof(MUINT32)*4); 
				#if 0
						for (i = 0 ; i<12 ; i++ ){
						printk("sn_inf_sub_s5k3p9sp04pd2078[%d]= 0x%x\n", i, sn_inf_sub_s5k3p9sp04pd2078[i]);
						}
				#endif
			}
				break;
...
UINT32 S5K3P9SP04PD2078_MIPI_RAW_SensorInit(
