...
#include "gc02m1bpd2078mipimono_Sensor.h"

/****************************Modify Following Strings for Debug****************************/
#define PFX "GC02M1BPD2078_camera_sensor"
#define LOG_1 LOG_INF("GC02M1BPD2078,MIPI 1LANE\n")
/****************************   Modify end    *******************************************/
...
static struct imgsensor_info_struct imgsensor_info = {
	/*.sensor_id = GC02M1BPD2078_SENSOR_ID, */
	.sensor_id = GC02M1BPD2078_SENSOR_ID,
...
static kal_uint16 set_gain(kal_uint16 gain)
{
	...
	if ((ANALOG_GAIN_1 <= iReg) && (iReg < ANALOG_GAIN_2)) {
		...
		LOG_INF
		    ("GC02M1BPD2078MIPI analogic gain 1x, GC02M1BPD2078MIPI add pregain = %d\n",
		     temp);
		...
		write_cmos_sensor(0xb2, (temp & 0xff));
		LOG_INF
		    ("GC02M1BPD2078MIPI analogic gain 1.185x, GC02M1BPD2078MIPI add pregain = %d\n",
		     temp);
		...
		write_cmos_sensor(0xb2, (temp & 0xff));
		LOG_INF
		    ("GC02M1BPD2078MIPI analogic gain 1.4x, GC02M1BPD2078MIPI add pregain = %d\n",
		     temp);
		...
		write_cmos_sensor(0xb2, (temp & 0xff));
		LOG_INF
		    ("GC02M1BPD2078MIPI analogic gain 1.659x, GC02M1BPD2078MIPI add pregain = %d\n",
		     temp);
		...
		write_cmos_sensor(0xb2, (temp & 0xff));
		LOG_INF
		    ("GC02M1BPD2078MIPI analogic gain 2.0x, GC02M1BPD2078MIPI add pregain = %d\n",
		     temp);
		...
		write_cmos_sensor(0xb2, (temp & 0xff));
		LOG_INF
		    ("GC02M1BPD2078MIPI analogic gain 2.37x, GC02M1BPD2078MIPI add pregain = %d\n",
		     temp);
		...
		write_cmos_sensor(0xb2, (temp & 0xff));
		LOG_INF
		    ("GC02M1BPD2078MIPI analogic gain 2.8x, GC02M1BPD2078MIPI add pregain = %d\n",
		     temp);
		...
		write_cmos_sensor(0xb2, (temp & 0xff));
		LOG_INF
		    ("GC02M1BPD2078MIPI analogic gain 3.318x, GC02M1BPD2078MIPI add pregain = %d\n",
		     temp);
		...
		write_cmos_sensor(0xb2, (temp & 0xff));
		LOG_INF
		    ("GC02M1BPD2078MIPI analogic gain 4.0x, GC02M1BPD2078MIPI add pregain = %d\n",
		     temp);
		...
		write_cmos_sensor(0xb2, (temp & 0xff));
		LOG_INF
		    ("GC02M1BPD2078MIPI analogic gain 4.74x, GC02M1BPD2078MIPI add pregain = %d\n",
		     temp);
		...
		write_cmos_sensor(0xb2, (temp & 0xff));
		LOG_INF
		    ("GC02M1BPD2078MIPI analogic gain 5.6x, GC02M1BPD2078MIPI add pregain = %d\n",
		     temp);
		...
		write_cmos_sensor(0xb2, (temp & 0xff));
		LOG_INF
		    ("GC02M1BPD2078MIPI analogic gain 6.636x, GC02M1BPD2078MIPI add pregain = %d\n",
		     temp);
		...
		write_cmos_sensor(0xb2, (temp & 0xff));
		LOG_INF
		    ("GC02M1BPD2078MIPI analogic gain 8.0x, GC02M1BPD2078MIPI add pregain = %d\n",
		     temp);
		...
		write_cmos_sensor(0xb2, (temp & 0xff));
		LOG_INF
		    ("GC02M1BPD2078MIPI analogic gain 9.48x, GC02M1BPD2078MIPI add pregain = %d\n",
		     temp);
		...
		write_cmos_sensor(0xb2, (temp & 0xff));
		LOG_INF
		    ("GC02M1BPD2078MIPI analogic gain 11.2x, GC02M1BPD2078MIPI add pregain = %d\n",
		     temp);
	}
	else {
		write_cmos_sensor(0xfe, 0x00);
...
static void sensor_init(void)
{
	...
	write_cmos_sensor(0x26, 0x07); //08
	write_cmos_sensor(0x29, 0x06);
	write_cmos_sensor(0x2a, 0x0c);
	write_cmos_sensor(0x2b, 0x07); //08
...
static kal_uint32 get_imgsensor_id(UINT32 *sensor_id)
{
	...
	kal_uint8 timeout = 0;
	timeout = check_i2c_timeout(0xf0, imgsensor.i2c_write_id);
    if (timeout) {
	...
	while (imgsensor_info.i2c_addr_table[i] != 0xff) {
		...
		do {
			*sensor_id = return_sensor_id();
			...
			pr_err
			    ("Read sensor id fail, write id: 0x%x, id: 0x%x imgsensor_info.sensor_id =0x%x\n",
...
UINT32 GC02M1BPD2078_MIPI_MONO_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc)
{
	/* To Do : Check Sensor status here */
	if (pfFunc != NULL)
		*pfFunc = &sensor_func;
	return ERROR_NONE;
}				/*    GC02M1BPD2078_MIPI_RAW_SensorInit    */
