 ...
 * Filename:
 * ---------
 *	 s5kgh1sm24pd2078mipiraw_Sensor.c
 *
 * Project:
 * --------
 *	 ALPS
...
#include "s5kgh1sm24pd2078mipiraw_Sensor.h"
#include "../imgsensor_common.h"

#include "s5kgh1sm24pd2078mipiraw_freq.h"
...
static struct imgsensor_info_struct imgsensor_info = {
	.sensor_id = S5KGH1SM24PD2078_SENSOR_ID,
	...
	.custom6 = { /*cpy from preview 4:3 3648*2736@30fps*/
		.pclk =1543000000,
		.linelength = 12974,
		.framelength = 3967,
		.startx =0,
	...
	.custom7 = {	/*cpy from preview 4:3 3648*2736@30fps*/
		.pclk =1543000000,
		.linelength = 12974,
		.framelength = 3967,
		.startx =0,
	...
	.custom8 = {	/*cpy from preview 4:3 3648*2736@30fps*/
		.pclk =1543000000,
		.linelength = 12974,
		.framelength = 3967,
		.startx =0,
	...
	.custom9 = {	/*cpy from preview 4:3 3648*2736@30fps*/
		.pclk =1543000000,
		.linelength = 12974,
		.framelength = 3967,
		.startx =0,
	...
	.custom10 = {	/*cpy from preview 4:3 3648*2736@30fps*/
		.pclk =1543000000,
		.linelength = 12974,
		.framelength = 3967,
		.startx =0,
...
static struct SENSOR_WINSIZE_INFO_STRUCT imgsensor_winsize_info[15] = {  
	...
	{ 7968, 5480,	336,	4,	7296, 5472, 3648, 2736, 0000, 0000, 	3648,  2736,	  0,	0,	3648,  2736}, /*custom6*/
	{ 7968, 5480,	336,	4,	7296, 5472, 3648, 2736, 0000, 0000, 	3648,  2736,	  0,	0,	3648,  2736}, /*custom7*/
	{ 7968, 5480,	336,	4,	7296, 5472, 3648, 2736, 0000, 0000, 	3648,  2736,	  0,	0,	3648,  2736}, /*custom8*/
	{ 7968, 5480,	336,	4,	7296, 5472, 3648, 2736, 0000, 0000, 	3648,  2736,	  0,	0,	3648,  2736}, /*custom9*/
	{ 7968, 5480,	336,	4,	7296, 5472, 3648, 2736, 0000, 0000, 	3648,  2736,	  0,	0,	3648,  2736}, /*custom10*/
...
extern otp_error_code_t S5KGH1SM24PD2078_OTP_ERROR_CODE;
MUINT32  sn_inf_sub_s5kgh1sm24pd2078[13];  /*0 flag   1-12 data*/
MUINT32  material_inf_sub_s5kgh1sm24pd2078[4]; 
MUINT32  af_calib_inf_sub_s5kgh1sm24pd2078[6];     
...
static kal_uint16 addr_data_pair_custom10[] = {
...
{
	PK_DBG("start \n");
	table_write_cmos_sensor(addr_data_pair_custom9,
		   sizeof(addr_data_pair_custom9) / sizeof(kal_uint16));
	PK_DBG("end \n");
}
static void custom10_setting(void)
{
	PK_DBG("start \n");
	table_write_cmos_sensor(addr_data_pair_custom10,
		   sizeof(addr_data_pair_custom10) / sizeof(kal_uint16));
	PK_DBG("end \n");
}
#endif
	...
	case SENSOR_FEATURE_GET_CUSTOM_INFO:
		...
		switch (*feature_data) {
			...
			if (*feature_para_len >= sizeof(MUINT32)*13 + 2) {
			    *(MUINT32 *)(uintptr_t)(*(feature_data+1)) = S5KGH1SM24PD2078_OTP_ERROR_CODE;//otp_state
				memcpy( feature_data+2, sn_inf_sub_s5kgh1sm24pd2078, sizeof(MUINT32)*13); 
				memcpy( feature_data+10, material_inf_sub_s5kgh1sm24pd2078, sizeof(MUINT32)*4); 
				memcpy( feature_data+12, af_calib_inf_sub_s5kgh1sm24pd2078, sizeof(MUINT32)*6);
				#if 0
						for (i = 0 ; i<12 ; i++ ){
						printk("sn_inf_sub_s5kgh1sm24pd2078[%d]= 0x%x\n", i, sn_inf_sub_s5kgh1sm24pd2078[i]);
						}
				#endif
			}
				break;
...
UINT32 S5KGH1SM24PD2078_MIPI_RAW_SensorInit(
